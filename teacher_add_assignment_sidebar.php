<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		<li class=""><a href="dasboard_teacher.php">&nbsp;Classes</a></li>
		<li class=""><a href="notification_teacher.php">&nbsp;Notifications
			<?php if($not_read == '0'){
				}else{ ?>
					<span class="badge badge-important"><?php echo $not_read; ?></span>
				<?php } ?>
		</a></li>
		<li class=""><a href="teacher_message.php"></i>&nbsp;Messages</a></li>  
		<li class=""><a href="add_downloadable.php">&nbsp;Upload Files</a></li> 
		<li class=""><a href="add_announcement.php">&nbsp;Add Announcement</a></li> 
		<li class="active"><a href="add_assignment.php">&nbsp;Add Assignment</a></li>
